    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attendee', models.ManyToManyField(related_name='events', to='levelupapi.gamer')),
                ('game', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='events_game', to='levelupapi.game')),
                ('organizer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='games', to='levelupapi.gamer')),
            ],
        ),
    ]
